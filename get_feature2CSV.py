...
predictor = dlib.shape_predictor(r"model_feature/shape_predictor_68_face_landmarks.dat")

# face recognition model, the object maps human faces into 128D vectors
facerec = dlib.face_recognition_model_v1(r"model_feature/dlib_face_recognition_resnet_model_v1.dat")
...
def compute_the_mean(path_csv_rd):
    ...
    for i in range(128):
        ...
        # 计算某一个特征
        feature_mean.append(tmp_arr)
    return feature_mean


# 存放所有特征均值的 CSV 的路径
path_csv_feature_all = "csv/features_all.csv"
# 存放人脸特征的csv的路径
path_csv_rd = "csv/"
